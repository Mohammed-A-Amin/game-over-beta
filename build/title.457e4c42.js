...
})({"2wO32":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "67ec0e0c457e4c42";
...
},{}],"5Hqx2":[function(require,module,exports) {
...
function createPlayer() {
    if (window.localStorage.getItem("player") === null) {
        ...
        _dataJs.updateLocalStorage(newPlayer);
...
parcelHelpers.export(exports, "displayRank", ()=>displayRank
);
parcelHelpers.export(exports, "loadData", ()=>loadData
);
parcelHelpers.export(exports, "riskCreate", ()=>riskCreate
);
parcelHelpers.export(exports, "addRisk", ()=>addRisk
);
parcelHelpers.export(exports, "subtractRisk", ()=>subtractRisk
);
parcelHelpers.export(exports, "dogeRisk", ()=>dogeRisk
);
...
parcelHelpers.export(exports, "loadPlayerProfile", ()=>loadPlayerProfile
);
...
function displayRank() {
    ...
    if (currentPlayer.coins < 50) rank.innerHTML = "Horseman";
    else if (currentPlayer.coins >= 50 && currentPlayer.coins < 100) rank.innerHTML = "Lancer";
    else if (currentPlayer.coins >= 100 && currentPlayer.coins < 200) rank.innerHTML = "Keeper";
    else if (currentPlayer.coins >= 200 && currentPlayer.coins < 400) rank.innerHTML = "Guardian";
    else if (currentPlayer.coins >= 400 && currentPlayer.coins < 1000) rank.innerHTML = "Justicar";
    else if (currentPlayer.coins >= 1000 && currentPlayer.coins < 2000) rank.innerHTML = "Paladin";
    else if (currentPlayer.coins >= 2000 && currentPlayer.coins < 4000) rank.innerHTML = "Executioner";
    else if (currentPlayer.coins >= 4000 && currentPlayer.coins < 10000) rank.innerHTML = "Lieutenant";
    else if (currentPlayer.coins >= 10000 && currentPlayer.coins < 30000) rank.innerHTML = "Commander";
    else if (currentPlayer.coins >= 30000) rank.innerHTML = "Divine Knight";
}
function loadData() {
    coinDisplay.innerHTML = currentPlayer.coins;
...
function riskCreate() {
    ...
    let reset1 = document.getElementById("resetRisk");
...
function loadPlayerProfile() {
    if (window.localStorage.getItem("player") === null) return;
    else {
...
},{}]},["2wO32","5Hqx2"], "5Hqx2", "parcelRequirefa75")

//# sourceMappingURL=title.457e4c42.js.map
